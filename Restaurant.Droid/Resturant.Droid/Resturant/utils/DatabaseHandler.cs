...
namespace com.resturant.Droid.Resturant.utils
{
    public class DatabaseHandler : SQLiteOpenHelper
    {
        ...
        public static string COLUMN_WAREHOUSE_ID = "warehouseId";
        ...
        public static string COLUMN_ROWSTATE = "rowstate";
        ...
        public override void OnCreate(SQLiteDatabase db)
        {
            ...
            string exe = "CREATE TABLE IF NOT EXISTS " + CART_TABLE
                    ...
                    + COLUMN_WAREHOUSE_ID + " integer NOT NULL,"
                    ...
                    + COLUMN_ROWSTATE + " integer NOT NULL "
                    + ")";
        ...
        public bool setCart(Dictionary<string, string> map, int Qty)
        {
            ...
            else
            {
                ...
                values.Put(COLUMN_WAREHOUSE_ID, map.GetValueOrDefault(COLUMN_WAREHOUSE_ID));
                values.Put(COLUMN_ROWSTATE, map.GetValueOrDefault(COLUMN_ROWSTATE));
        ...
        public List<Dictionary<string, string>> getCartAll()
        {
            ...
            for (int i = 0; i < cursor.Count; i++)
            {
                ...
                map.Add(COLUMN_WAREHOUSE_ID, cursor.GetString(cursor.GetColumnIndex(COLUMN_WAREHOUSE_ID)));
                map.Add(COLUMN_ROWSTATE, cursor.GetString(cursor.GetColumnIndex(COLUMN_ROWSTATE)));
                list.Add(map);
                cursor.MoveToNext();
            }
            return list;
